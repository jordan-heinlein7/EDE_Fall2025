...
USGS.flow.data[30000:30005, c(3, 8, 14)] #specific sub sample of dataframe
...
USGS.flow.data$datetime <- as.Date(USGS.flow.data$datetime, format = "%m/%d/%y") #dates formatted with / in raw table
```
...
write.csv(
  ...
  row.names=FALSE)
#now that data has been manipulated, save in Processed folder
```
