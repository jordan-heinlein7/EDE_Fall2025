...
## Report the summary
To make a table, use 'knitr:: kable(name of data frame)'. Can add additional
arguments like 'caption' to add a table caption.
...
can run r code within text if code placed between 'r '. Example:
