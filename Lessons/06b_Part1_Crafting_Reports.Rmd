...
-   `#`: headings, number of \# corresponding to heading sizes

-   `>`: block quotes. To insert text that can span multiple lines
...
-   
    ...
    ## Unordered lists... (bulleted list use \* or '-')

    -   

    -   

-   Hyperlinks... [text](link%20address)
...
-   `\newpage`: add above code chunk to start new page
-   `\listoftables`
-   `\listoffigurres`: creates clickable list of figures in report
-   `---`
