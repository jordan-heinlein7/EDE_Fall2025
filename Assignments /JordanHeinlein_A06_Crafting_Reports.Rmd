...
```{r echo=FALSE, fig.cap="2018 monthly Ozone levels", warning=FALSE, fig.align='left', fig.dim= c(11,4.5)}
OzoneDist2018.plot <- epa_data %>% 
  filter(Year == 2018) %>% 
  ggplot(
 ...
 print(OzoneDist2018.plot)
```
**Monthly Ozone concentrations (2019)**
```{r echo=FALSE, fig.cap= "2019 monthly Ozone levels", warning=FALSE, fig.align='left', fig.dim= c(11,4.5)}
OzoneDist2019.plot <- epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(
    aes(x = factor(Month, levels= 1:12, labels= month.abb), y = Ozone)
  ) +
...
## Git Repository
<https://github.com/jordan-heinlein7/EDE_Fall2025>
